                    ...
                    <div class="col-12">
                        <table class="table table-striped" style="vertical-align: middle;">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="gap-2 mx-auto form" style="padding: 1rem;">
                                        <a href="modificaPacientesS.html" type="button">
                                            <button>Modificar</button>
                                        </a>
                                        <a href="eliminaPacientesS.html" type="button">
                                            <button>Borrar</button>
                                        </a>
                                        <a href="consultaPacientesS.php" type="button">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="gap-2 mx-auto form" style="padding: 1rem;">
                                        <a href="modificaPacientesS.php" type="button">
                                            <button>Modificar</button>
                                        </a>
                                        <a href="eliminaPacientesS.php" type="button">
                                            <button>Borrar</button>
                                        </a>
                                        <a href="consultaPacientesS.php" type="button">
                                            <button>Consultar</button>
