                ...
                <div class="tab-pane fade show active" id="receta" role="tabpanel" aria-labelledby="receta-tab">
                    ...
                    <form id="recetaForm" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="intruccionUsoR" rows="8" placeholder="intruccionUsoR"
                                name="intruccionUsoR" required style="resize: none"></textarea>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12" style="margin-bottom: 20px;">
                            <div class="row align-items-center">
                                <div class="col-md-11">
                                    <input type="text" class="form-control" placeholder="Buscar paciente por nombre"
                                        id="nombrePaciente">
                                </div>
                                <div class="col-md-1">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                <input type="text" class="form-control" id="apellidoPacientePaternoCita"
                                                    name="apellidoPacientePaternoCita" placeholder="Apellido Paterno"
                                                    required>

                                            </div>
                                            <div class="col-md-3">
                                                <input type="text" class="form-control" id="apellidoPacienteMaternoCita"
                                                    name="apellidoPacienteMaternoCita" placeholder="Apellido Materno"
                                                    required>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-select" id="especialidadCita"
                                                        name="especialidadCita" aria-label="Especialidad select menu"
                                                        required>
                                        ...
                                        <div class="row align-items-center">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" id="motivoCita" name="motivoCita"
                                                    rows="3" placeholder="Diagnóstico del paciente" required></textarea>
                                            </div>
